...
AutoCode 是一款专为 macOS 设计的智能验证码助手，能够自动监听并提取来自多个来源的 2FA 验证码，让你的登录体验更加流畅。
...
AutoCode is an intelligent 2FA code assistant designed for macOS that automatically monitors and extracts verification codes from multiple sources, making your login experience seamless.
